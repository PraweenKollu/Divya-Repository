...
public class Listeners extends BasePage implements ITestListener {
	...
	public void onTestSuccess(ITestResult arg0) {
		...
		if (arg0.isSuccess()) {
			...
			String reportgdirectory = (new File(System.getProperty("user.dir")).getAbsolutePath()
					+ "/src/main/java/com/durgasoft/ecommerce");
			File target = new File((String) reportgdirectory + "/passedscreens/" + methodname
	...
	public void onTestFailure(ITestResult arg0) {
		...
		if (!arg0.isSuccess()) {
			...
			String reportgdirectory = (new File(System.getProperty("user.dir")).getAbsolutePath()
					+ "/src/main/java/com/durgasoft/ecommerce");
			File target = new File((String) reportgdirectory + "/failedscreens/" + methodname
					+ simpledate.format(cal.getTime()) + ".png");
			try {
				FileUtils.copyFile(src, target);
			} catch (IOException e) {
